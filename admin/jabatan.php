...
$query = 'SELECT outlet.*, user.nama_user FROM outlet LEFT JOIN user ON user.jabatan_id = outlet.id_jabatan';
                        ...
                        <table id="basic-datatables" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            <td><?= $outlet['nama_jabatan']; ?></td>
                                           <!-- <td><?php if ($outlet['golongan'] == null) {
                                                    echo "Belum ada owner";
                                                } else {
                                                    echo $outlet['nama_user'];
                                                } ?>
                                            </td> -->
                                            <td><?= $outlet['golongan']; ?></td>
